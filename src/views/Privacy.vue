  ...
  <div>
    ...
    >
      ...
      >
        ...
        <p>
          DeveloperAdam built the Worldie app as a Free app. This SERVICE is
          ...
          Conditions, which are accessible at Worldie unless otherwise defined
        ...
        <h2 class="text-sm font-boldHeadline mt-2">Cookies</h2>
        <p>
        ...
        <h2 class="text-sm font-boldHeadline mt-2">Service Providers</h2>
        <p>
        ...
        <h2 class="text-sm font-boldHeadline mt-2">Security</h2>
        <p>
        ...
        <h2 class="text-sm font-boldHeadline mt-2">Links to Other Sites</h2>
        <p>
        ...
        <h2 class="text-sm font-boldHeadline mt-2">Children’s Privacy</h2>
        <p>
        ...
        <p>
          ...
          page. This policy is effective as of 29-12-2021
        </p>

        <h2 class="text-sm font-boldHeadline mt-2">Contact Us</h2>
        <p>
          If you have any questions or suggestions about my Privacy Policy, do
          not hesitate to contact me at worldiecontact@gmail.com.
        </p>
      </h1>
    </div>
