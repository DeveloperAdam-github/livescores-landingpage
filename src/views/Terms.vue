<template>
  <div>
    <div
      class="p-5 w-full flex flex-col text-black dark:text-white items-center justify-center px-4 md:px-40 overflow-scroll"
    >
      <div
        class="h-full w-full flex items-center justify-center text-5xl flex-col font-boldHeadline mt-96"
      >
        <h1>W<i class="text-purple far fa-futbol"></i>rldie</h1>
        <small class="text-sm">Live football scores</small>
      </div>
      <!-- <h1
        class="text-xs font-headline uppercase text-secondary dark:text-primary"
      >
        <h2 class="text-sm font-boldHeadline mt-2">Terms & Conditions</h2>
        <p>
          ...
          related to it, still belong to DeveloperAdam. DeveloperAdam is
          ...
          very clear to you exactly what you’re paying for. The Worldie app
          ...
          security features and it could mean that the Worldie app won’t work
          ...
          should be aware that there are certain things that DeveloperAdam will
          ...
          Wi-Fi or provided by your mobile network provider, but DeveloperAdam
          ...
          the same lines, DeveloperAdam cannot always take responsibility for
          ...
          avail the Service, DeveloperAdam cannot accept responsibility. With
          respect to DeveloperAdam’s responsibility for your use of the app,
          ...
          that we can make it available to you. DeveloperAdam accepts no
          ...
          may wish to update the app. The app is currently available on iOS –
          the requirements for the system(and for any additional systems we
          ...
          DeveloperAdam does not promise that it will always update the app so
        ...
        <h2 class="text-sm font-boldHeadline mt-2">
        ...
        <p>
          ...
          this page. These terms and conditions are effective as of 2021-12-29
        </p>

        <h2 class="text-sm font-boldHeadline mt-2">Contact Us</h2>
        <p>
          If you have any questions or suggestions about my Terms and
          Conditions, do not hesitate to contact me at worldiecontact@gmail.com.
        </p>
      </h1> -->
    </div>
